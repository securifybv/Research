		...
		super(update_info(info,
			...
			'References'	=>
				[
					...
					['OSVDB', '66296'],
					['BID', '41446'],
					['URL', 'http://www.securify.nl/advisory/SFY20091001/outlook_pr_attach_method_file_execution_vulnerability.html'],
				],
		...
		register_options(
			[
				...
				OptString.new('MAILSUBJECT',
					[false, 'The subject of the sent email', 'readme.txt']),
