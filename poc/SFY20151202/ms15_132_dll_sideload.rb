		...
		super(update_info(info,
			...
			'References' =>
				[
					...
					['CVE', '2015-6133'],
					['MSB', 'MS15-132'],
					['URL', 'https://securify.nl/blog/SFY20151201/there_s_a_party_in_ole__and_you_are_invited.html'],
			...
			'Targets' =>
				[
					[ 'All', {} ],
					[
						'COM+ Services / Windows Vista - 10 / Office 2007 - 2016',
							{
								'DLL' => 'mqrt.dll',
					...
					[
						'Shockwave Flash Object / Windows 10 / Office 2013',
							{
								'DLL' => 'spframe.dll',
					...
					[
						'Windows Authentication UI / Windows 10 / Office 2013 - 2016',
							{
								'DLL' => 'wuaext.dll',
					...
					[
						'Shutdown UX / Windows 10 / Office 2016',
							{
								'DLL' => 'wuaext.dll',
					...
					[
						'Event Viewer Snapin / Windows Vista - 7 / Office 2007 - 2013',
							{
								'DLL' => 'elsext.dll',
					...
					[
						'OLE DB Provider for Oracle / Windows Vista - 7 / Office 2007 - 2013',
							{
								'DLL' => 'oci.dll',
			...
			'Privileged' => false,
			'DisclosureDate' => 'December 8 2015',
			'DefaultTarget' => 0))
